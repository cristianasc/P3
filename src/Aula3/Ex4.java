...
public class Ex4 {
	...
	public static void main(String args[]){
		Aluno[] arrEstudante = new Aluno[0];
	...
	private static Aluno[] addEstudante(Aluno[] arr){
		...
		Aluno arr2[]= new Aluno[arr.length+1];
	...
	private static Aluno[] delEstudante(Aluno[] arr){
	...
	private static Emprestimo[] checkout(Emprestimo[] arr, Aluno[] arr1, Funcionario[] arr2, Videos[] arr3, int quotas, int count){
		System.out.print("Número de sócio:");
		int nrSocio = sc.nextInt();
				...
				for(int j= 0; j<arr2.length;j++){
					for(int h= 0; h<arr3.length;h++){
						if(arr1[k].nrSocio()==nrSocio && arr[i].ID()==id){
							arr1[k].historicoVideo(arr3[h]);
						}
						else if(arr2[j].nrSocio()==nrSocio && arr[i].ID()==id){
							arr2[j].historicoVideo(arr3[h]);
						}
					}
				}
			}
	...
	private static void listVideoDisp(Videos[] arr, Emprestimo arr1[], Aluno[] arr2, Funcionario[] arr3){
		System.out.print("Número de sócio:");
		int nrSocio = sc.nextInt();
	...
	private static void listHistorico(Aluno[] arr, Funcionario[] arr1){
		System.out.print("Número de sócio:");
		int nrSocio = sc.nextInt();
